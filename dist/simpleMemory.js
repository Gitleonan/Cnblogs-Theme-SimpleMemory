!function () {
    var e, s, a, t, o, l, n = {
        434: function (e, s, a) {
            ...
            function t(e) {
                let s = {
                    init: () => {
                        e.__event.scroll = {}, e.__event.scroll.handle = [], e.__event.scroll.temScroll = 0, e.__event.scroll.docScroll = $(document).scrollTop(), e.__event.scroll.homeScroll = $("#home").offset().top - 40, $(window).scroll((() => {
                            e.__event.scroll.docScroll = $(document).scrollTop(), e.__event.scroll.homeScroll = $("#home").offset().top - 40, s.handle.scroll(), e.__event.scroll.temScroll = e.__event.scroll.docScroll
                        })), e.__event.resize = {}, e.__event.resize.handle = [], $(window).resize((() => {
                            s.handle.resize()
                        }))
                    }, handle: {
                        scroll: () => {
            ...
            function o(e) {
                ...
                var s = t[e], o = s[0];
                return Promise.all(s.slice(1).map(a.e)).then((function () {
                    return a(o)
                }))
            }
    ...
    i.m = n, i.n = function (e) {
        ...
        var l = {};
        e = e || [null, s({}), s([]), s(s)];
        for (var n = 2 & t && a; "object" == typeof n && !~e.indexOf(n); n = s(n)) Object.getOwnPropertyNames(n).forEach((function (e) {
            l[e] = function () {
                return a[e]
            }
        }));
        ...
        return Promise.all(Object.keys(i.f).reduce((function (s, a) {
            return i.f[a](e, s), s
        }), []))
    }, i.u = function (e) {
        return "script/" + ({
        ...
        if (a[e]) a[e].push(s); else {
            var n, r;
            if (void 0 !== o) for (var c = document.getElementsByTagName("script"), h = 0; h < c.length; h++) {
                var u = c[h];
            ...
            n || (r = !0, (n = document.createElement("script")).charset = "utf-8", n.timeout = 120, i.nc && n.setAttribute("nonce", i.nc), n.setAttribute("data-webpack", t + o), n.src = e), a[e] = [s];
            var d = function (s, t) {
            ...
            }, f = setTimeout(d.bind(null, void 0, {type: "timeout", target: n}), 12e4);
        ...
        if (!e && s && (s.currentScript && (e = s.currentScript.src), !e)) {
            ...
            if (a.length) for (var t = a.length - 1; t > -1 && !e;) e = a[t--].src
        }
        if (!e) throw new Error("Automatic publicPath is not supported in this browser");
        e = e.replace(/#.*$/, "").replace(/\?.*$/, "").replace(/\/[^\/]+$/, "/"), i.p = e
    }(), o = function (e) {
        return new Promise((function (s, a) {
            var t = i.miniCssF(e), o = i.p + t;
            if (function (e, s) {
                for (var a = document.getElementsByTagName("link"), t = 0; t < a.length; t++) {
                    var o = (n = a[t]).getAttribute("data-href") || n.getAttribute("href");
                    if ("stylesheet" === n.rel && (o === e || o === s)) return n
                }
                var l = document.getElementsByTagName("style");
                for (t = 0; t < l.length; t++) {
                    var n;
                    if ((o = (n = l[t]).getAttribute("data-href")) === e || o === s) return n
                }
            }(t, o)) return s();
            !function (e, s, a, t) {
                var o = document.createElement("link");
                o.rel = "stylesheet", o.type = "text/css", o.onerror = o.onload = function (l) {
                    if (o.onerror = o.onload = null, "load" === l.type) a(); else {
                        var n = l && ("load" === l.type ? "missing" : l.type), r = l && l.target && l.target.href || s,
    ...
    }, l = {179: 0}, i.f.miniCss = function (e, s) {
        l[e] ? s.push(l[e]) : 0 !== l[e] && {
            ...
            9914: 1,
            9996: 1
        }[e] && s.push(l[e] = o(e).then((function () {
            l[e] = 0
        }), (function (s) {
            throw delete l[e], s
        })))
        ...
        i.f.j = function (s, a) {
            ...
            if (0 !== t) if (t) a.push(t[2]); else {
                ...
                a.push(t[2] = o);
                var l = i.p + i.u(s), n = new Error;
                i.l(l, (function (a) {
                    if (i.o(e, s) && (0 !== (t = e[s]) && (e[s] = void 0), t)) {
                        var o = a && ("load" === a.type ? "missing" : a.type), l = a && a.target && a.target.src;
        ...
        var e = JSON.parse('{"info":{"name":"","startDate":"2021-01-01","avatar":"","blogIcon":""},"sidebar":{"navList":[],"customList":{},"infoBackground":"","titleMsg":"欢迎访问本博客~","submenu":{"pointsRank":false,"latestPosts":false,"myTags":false,"postsClassify":false,"articleClassify":false,"readRank":false,"recommendRank":false,"latestComment":false,"postsArchive":false,"articleArchive":false,"customList":false}},"banner":{"home":{"background":[],"title":[],"titleSource":"jinrishici"},"article":{"background":[]}},"loading":{"rebound":{"tension":16,"friction":5},"spinner":{"id":"spinner","radius":90,"sides":3,"depth":4,"colors":{"background":"#f0f0f0","stroke":"#272633","base":null,"child":"#272633"},"alwaysForward":true,"restAt":0.5,"renderBase":false}},"fontIconExtend":"","progressBar":{"id":"top-progress-bar","color":"#77b6ff","height":"2px","duration":0.2},"title":{"onblur":"(oﾟvﾟ)ノ Hi","onblurTime":500,"focus":"(*´∇｀*) 欢迎回来！","focusTime":1000},"footer":{"text":{"left":"","right":"","iconFont":{"icon":"icon-xl","color":"red","fontSize":"16px"}},"style":2,"aplayer":{"enable":false,"cdn":{"aplayer":"https://lf26-cdn-tos.bytecdntp.com/cdn/expire-1-y/aplayer/1.10.1/APlayer.min.js","aplayercss":"https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-y/aplayer/1.10.1/APlayer.min.css","meting":"https://cdn.staticfile.org/meting/2.0.1/Meting.min.js"},"options":{"id":"3778678","api":"","server":"netease","type":"playlist","auto":"netease","fixed":"true","mini":"true","autoplay":"false","theme":"#2980b9","loop":"all","order":"random","preload":"auto","volume":"0.7","mutex":"true","lrcType":"0","listFolded":"true","listMaxHeight":"340px","storageName":"cnblogsTheme"}}},"links":{"footer":[],"page":[]},"cnzz":"","rtMenu":{"qrCode":"","reward":{"alipay":"","wechatpay":""},"downScrollDom":""},"switchDayNight":{"enable":true,"nightMode":false,"auto":{"enable":false,"dayHour":5,"nightHour":19}},"animate":{"homeBannerTitle":{"enable":false},"bannerImages":{"enable":false,"options":{"itemNum":5,"current":0,"sort":1,"time":30000}},"homeBanner":{"enable":false,"options":{"radius":15,"density":0.2,"color":"rgba(255,255,255, .2)","clearOffset":0.3}},"articleTitle":{"enable":false},"articleBanner":{"enable":false},"background":{"enable":false,"options":{"colorSaturation":"60%","colorBrightness":"50%","colorAlpha":0.5,"colorCycleSpeed":5,"verticalPosition":"random","horizontalSpeed":200,"ribbonCount":3,"strokeSize":0,"parallaxAmount":-0.2,"animateSections":true}},"backgroundMouse":{"enable":false},"mouse":{"enable":false,"options":{"size":8,"sizeF":36}},"season":{"enable":false,"options":{"img":"data:image/jpg;base64,","size":40}},"avatar":{"enable":false}},"code":{"type":"","options":{"hljs":{"theme":"atom-one-dark-reasonable","languages":[]},"maxHeight":"","fontSize":14,"line":false,"macStyle":true}},"articleSuffix":{"imgUrl":"","aboutHtml":"","copyrightHtml":"","supportHtml":""},"articleDirectory":{"position":"right","minBodyWeight":900,"autoWidthScroll":false},"articleComment":{"background":{"enable":false,"options":{"day":"","night":""}}},"articleContent":{"prefixIcon":{"enable":false,"options":{"link":"https://at.alicdn.com/t/c/font_3628204_t6n3fw8b1zn.js","iconfontArr":["hebaodan","bingtanghulu","kesong","qianceng","fengmi","feiyuguantou","shengjian","youtiao","yuzijiang","zhutongfan","doujiang","sanmingzhi","paofu","shanbei","dangaojuan","futejia","huangyou","xiangchang","banji","danta","qingning","lajiao","shizi","mojituo","pijiu","putaojiu","kouxiangtang","xiangcaobingqilin","jiaozi","tilamisu","huoguo","hongshu","bingkuai","mianhuatang","paobing","meishikafei","mantou","qishui","ganlan","jiroujuan","guodong","baozi","pingguo","chengzi","qingjiao","jidan","xihongshi","mangguo","baocai","niunai","mianbao","huluobu","zhangyu","pangxie","longxia","yangcong","rou","jitui","huage","xianyu","mogu","qiezi","xilanhua","ningmeng","liulian","banli","sanwenyu","tudou","xigua","nangua","huolongguo","fantuan","zhusun","shuiluobu","shanzhu","lanmei","shiliu","yezi","tiangua","mihoutao","boluo","kaixinguo","hetao","xiaweiyiguo","huasheng","bigenguo","kuihuazi","songzi","xiguazi","badanmu","yaoguo","danhuangsu","dangao","binggan","buding","tangguo","qiaokeli","hongzao","candou","putaogan","manyuemei","taozi","xiangjiao","caomei","niuyouguo","hamigua","chelizi","li","bale","kafei1","shutiao","zhenzhunaicha","xuegao","nailao","kele","tiantong","hanbao","xiezishousi","baomihua","regou","makalong","tianfuluo","juzi","baixiangguo","putao","shaomai","yumi","pipa","yangtao","youzi","lianwu","wuhuaguo","paomian","wandou","huanggua","suantou","tiantianquan","shupian","huafubing","bangbangtang","shousi","lizhi","doufu","mocha","boluomi","zhouzi","bingsha","suannai","pisa","haixing","haizhe","tongluoshao","nuomici","kuangquanshui","roujiamo","cha","zhangyuxiaowanzi","chengzhi","yuancaitou","baicai"]}}},"consoleList":[],"bookList":[],"hooks":{}}'),
            s = i.p + "images/ee72841e04451a25a448.png", a = i.p + "images/37c463dfee5621b391c9.png";
        var t = i(434);
        $(document).ready((function () {
            ...
            o.__config = function () {
                ...
                const a = void 0 !== s[4] ? s[4] : "", t = void 0 !== s[5] ? s[5] : "";
                if (4 !== s.length || $("#topics").length) {
                    $("#bookListFlg").length ? e.pageType = "books" : $("#linkListFlg").length ? e.pageType = "links" : e.pageType = a && t && "gallery" === a && "image" === t ? "galleryImage" : a && t && "gallery" === a && "image" !== t ? "gallery" : "article";
                ...
                batchTempReplacement: (e, s) => {
                    ...
                    return $.each(s, (function (e) {
                        let t = s[e], o = new RegExp("##" + t[0] + "##", "g");
                        a = a.replace(o, t[1])
                    })), a
                },
                dynamicLoadingCss: e => {
                    if (!e || 0 === e.length) throw new Error('argument "path" is required !');
                    let s = document.getElementsByTagName("head")[0], a = document.createElement("link");
                    a.href = e, a.rel = "stylesheet", a.type = "text/css", s.appendChild(a)
                },
                dynamicLoadingJs: e => new Promise(((s, a) => {
                    $.ajax({
                        type: "GET", dataType: "script", cache: !0, url: e, success: function (e) {
                            s(e)
                        }, error: function (e) {
                            a(e)
                        }
                ...
                actScroll: (e, s) => {
                    $("html,body").stop().animate({scrollTop: e}, s)
                },
                ...
                getNowFormatDate: () => {
                    let e = new Date, s = e.getFullYear(), a = e.getMonth() + 1, t = e.getDate();
                ...
                getRunDate: e => {
                    ...
                    let a = s, t = (new Date).getTime() - a.getTime(), o = t / 1e3, l = (Math.floor(o), t / 864e5),
                        n = Math.floor(l), r = -24 * (n - l), i = Math.floor(r), c = -60 * (i - r),
                        h = Math.floor(-60 * (i - r));
                    return {daysold: n, hrsold: i, minsold: h, seconds: Math.floor(-60 * (h - c)).toString()}
                },
                setCookie: (e, s, a) => {
                    let t = new Date;
                ...
                randomString: e => {
                    e = e || 32;
                    let s = "ABCDEFGHJKMNPQRSTWXYZabcdefhijkmnprstwxyz2345678", a = "";
                    for (let t = 0; t < e; t++) a += s.charAt(Math.floor(48 * Math.random()));
                    return a
                },
                minToTime: e => {
                    let s = parseInt(e), a = parseInt(60 * (e - s));
                    return a = 1 === ("" + a).length ? "0" + a : a, `${s}:${a}`
                },
                htmlReplace: (e, s, a) => {
                    $(e).html($(e).html().replace(s, a))
                },
                articleInfo: (e, s) => {
                    ...
                    $.each(e, (s => {
                        let o = $(e[s]);
                        o.prepend(`<span class="simple-memory-iconfont simple-memory-${a} iconfont ${a}"></span>`), $("#articleInfo").append(`<a href=" ${o.attr("href")}" target="_blank"><span class="article-info-tag ${t}"> ${o.text()}</span></a>`)
                    }))
                }
            }, o.__timeIds = {}, o.__event = {}, "" === o.__config.info.name && (o.__config.info.name = o.__status.user), i(6063)(`./${o.__status.pageType}`).then((e => {
                const s = e.default;
                Promise.all([i.e(9509), i.e(3304)]).then(i.bind(i, 7157)).then((e => {
                    (0, e.default)(o), s(o), i.e(3258).then(i.bind(i, 9450)).then((e => {
                        (0, e.default)(o), o.__tools.setDomHomePosition(), (0, t.Z)(o).handle.scroll(), (0, t.Z)(o).handle.resize()
                    }))
                }))
            }))
        }))
